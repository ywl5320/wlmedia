...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>version</b> with value <b>2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final GithubPluginAccessors paccForGithubPluginAccessors = new GithubPluginAccessors(providers, config);
    ...
    public static class GithubPluginAccessors extends PluginFactory {

        public GithubPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>github.plugin</b> with plugin id <b>com.github.dcendents:android-maven-gradle-plugin</b> and
         * with version reference <b>version</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("github.plugin"); }
